...
const blogData = [
  ...
  },
  {
    ...
    description:
      "其實是 AI 幫我在產生程式碼的時候看到一些奇怪的 Annotation，才發現還有型別擦除這件事情啊。慚愧慚愧。",
    author: "Kai　2025.8.5",
    tags: "Java, Spring Boot, redis, scan, keys, performance",
  },
  {
  ...
  },
  {
    ...
    description:
      "這是一篇紀錄 DDD 架構專案要如何執行、規劃、實作、思路的文章。可以 Clone 這個專案，其中的 readme 有更詳細的說明。",
  ...
  },
  {
    ...
    description:
      "一直以來在使用 Linux 時，只有熟悉那些常常用到的指令，例如 `cp` `mv` `rm` `ll` 這些，知道 `ll` 最前面有一串奇怪的字串是權限，但是從來沒有了解他到底在做什麼，直到最近專案上線，很多鬼故事發生...，我還是讀一下好了。",
  ...
  },
  {
    ...
    description:
      "因為之前都是用 VScode insider 整合 Github Copilot agent 和 MCP，Intellij 中的 Github copilot 沒有 Agent mode 可以用。最近又看到別人都用 Claude Desktop 整合 Intellij 和 MCP，沒道理我課 Copilot 的不行吧!!就來試試看。",
  ...
  },
  {
    ...
    description:
      "本來只是想練習一下 Redis Cluster 搭配 Redis stack 的 RedisJSON 與 Redisearch，沒想到 Redisearch 的限制這麼多，沒辦法好好搜尋，甚至必須犧牲 Redis Cluster 的優勢才能順利查詢。這個功能還是只適合單體的架構。",
  ...
  },
  {
    ...
    description:
      "最近要 Release 才知道用 Production 來打包跟一般自訂的環境打包有差這麼多......",
  ...
  },
  {
    ...
    description:
      "來複習一下 Angular 最基本的 生命週期，這篇文章會介紹 Angular 的生命週期，並且提供一個簡單的範例來說明。",
  ...
  },
  {
    ...
    description:
      "MCP Server 是一個可以讓我們在使用 AI Client 時，整合各家服務的介面類型 protocol，最近有點紅，就來玩一下。",
  ...
  },
  {
    ...
    category:
      "[踩雷] Spring Boot 啟動失敗：StackOverflowError 與循環變數問題紀錄",
    description:
      "最近專案上線進入Production，我出大包，居然無法啟動，想說改改環境變數應該不太需要重啟測試，結果就啟動失敗：StackOverflowError。",
    author: "Kai　2025.03.29",
  ...
  },
  {
    ...
    category:
      "[GIT]產出兩個 Git 分支間的程式碼差異報告（含繁體中文 UTF-8 處理）",
    description:
      "介紹使用 diff2html 工具產出程式碼差異比較報告及處理繁體中文 UTF-8 編碼問題。",
  ...
  },
  {
    ...
    description:
      "每次寫 Logback 的時候，都是東湊西湊，那乾脆把常用的功能與設定整理一下吧。",
  ...
  },
  {
    ...
    description:
      "在做各種專案的時候，都常常用到 Jackson 這個套件，這邊就來整理一下 Jackson 的常用功能與使用方法。",
  ...
  },
  {
    ...
    description:
      "真的在開發的時候，好像也不常用到這些指令，但需要用到的時候還是得分清楚挖!",
  ...
  },
  {
    ...
    description:
      "偶爾會用到 Hashing，不過都沒去搞懂他到底要幹嘛，哪些場景適合使用，就來寫一篇吧。也包含一般會員系統會怎麼處理密碼的部分。",
  ...
  },
  {
    ...
    description:
      "這篇主要是在介紹 Git Tag 的使用方式，以及如何在專案中使用 Tag 來做版本控制。",
  ...
  },
  {
    ...
    description:
      "這篇主要是在介紹 Java 專案壓力測試的進行流程與規劃，其中使用的壓力測試工具是 JMeter。",
  ...
  },
  {
    ...
    description:
      "這篇主要是介紹 Spring Boot Test 的基礎，並且實際寫一個簡單的測試案例。",
  ...
  },
  {
    ...
    description:
      "使用 Nginx 來設定 HTTPS，並藉由反向代理來導向我們的 Domain Name。",
    author: "Kai　20250121",
    tags: "Nginx",
  },
  {
  ...
  },
  {
    ...
    description:
      "最近專案在 LOG 紀錄時，想要用一些唯一值的方式來提升辨識度，所以查了一下 UUID, GUID, ULID 的差異，這邊做個筆記。",
  ...
  },
  {
    ...
    description:
      "準備 CKAD 考試的時候寫的筆記，滿多滿雜的，但都是考試範圍內的東西。希望對大家有幫助。",
  ...
  },
  {
    ...
    description:
      "這篇主要是介紹如何使用 Github Action 來做 CI/CD，其中包含 Angular, Spring Boot, Containerication, gmail notify，會在部屬完成後寄信通知。",
  ...
  },
  {
    ...
    description:
      "這篇主要是介紹如何將Angular專案打包成Docker Image，並上傳到Docker Hub，讓大家可以使用。",
  ...
  },
  {
    ...
    description:
      "這篇主要是介紹如何將Spring Boot專案打包成Docker Image，並上傳到Docker Hub，讓大家可以使用。",
    author: "Kai　2024.8.18",
  ...
  },
  {
    ...
    description:
      "這兩天專案上遇到要在很多地方處理 JWT，我提出 Filter 跟 Interceptor 都可以使用。查一查發現，對吼，我還有 Aspect 也可以達到一樣的目的。那到底，這三種到底有甚麼差別?",
  ...
  },
  {
    ...
    description:
      '前端送來 Get Request，可以直接回應 "redirect:/url"，但如果是 Post Request，要怎麼在 Java 端 Redirect 呢?',
  ...
  },
  {
    ...
    description:
      "平常很常使用 Spring boot 提供給我們的 Annotation，實在是有夠方便。如果也可以自己做一些 Annotation，就可以幫我做完一堆事情，感覺就很潮!",
    author: "Kai　2024.7.20",
    tags: "Java, Spring",
  },
  {
    ...
    description:
      "這篇主要是介紹如何在Spring Boot專案中使用Redis，簡單介紹各種操作，應該可以算是挺實用的!",
  ...
  },
  {
    ...
    description:
      "當我們在瀏覽器的網址列輸入一個URL，然後按下Enter鍵，瀏覽器就會開始載入網頁。大概寫寫發生甚麼事情~",
  ...
  },
  {
    ...
    description:
      "枚舉是一種特殊的類型，它可以用來表示一組固定的常數。枚舉在Java中是一個非常有用的功能，常常在各種情況下扮演重要的輔助腳色。",
    author: "Kai　2024.6.15",
    tags: "Java",
  },
  {
    ...
    description:
      '最近的專案是所謂的 "小網"，也就是一個嵌入在手機 APP 裡面的網頁。這個網頁同時有網頁版及手機版，但我們也不是專業的手機 APP 開發者，想要可以讓網及在開發階段即時呈現在手機上該怎麼做呢?',
  ...
  },
  {
    ...
    description:
      "物件導向設計(Object-Oriented Design, OOD)是一種軟體設計方法，它將軟體系統中的元素組織為物件(Object)。",
  ...
  },
  {
    ...
    description:
      "JIB 是一個專為 Java 開發者設計的 Docker Image Builder，它可以幫助開發者快速、簡單地構建 Java 應用的 Docker Image。",
    author: "Kai　2024.6.9",
    tags: "Java",
  },
  {
  ...
  },
  {
    ...
    category: "[Java] 陣列物件",
    description:
      "陣列在 Java 中是一種物件，它是一種容器，可以容納多個相同型別的元素。陣列的元素可以是基本型別或物件型別。",
  ...
  },
  {
    ...
    description:
      "C4 model是一種用於視覺化和描述軟件架構的方法，它提供了一套標準化的語言來描繪系統的各個層面。",
    author: "Kai　2024.5.29",
    tags: "Uncategorized",
  },
  {
    ...
    description:
      "Java基本型別包裹類別，包含基本型別、基本型別包裹類別、基本型別轉換、基本型別包裹類別轉換。",
  ...
  },
  {
    ...
    description:
      "一個函式應該只做一件事，做好這件事，只做一件事。 -資料來源 - Clean code 無瑕的程式碼。",
  ...
  },
  {
    ...
    description:
      "讓名稱代表意圖-使之名副其實。 -資料來源 - Clean code 無瑕的程式碼。",
    author: "Kai　2024.4.23",
    tags: "Clean Code",
  },
  {
    ...
    description:
      "Use the docker to install the splunk, and use the volume to persist the data.",
    author: "Kai　2024.4.23",
    tags: "Docker, Splunk",
  },
  {
    ...
    category:
      "[Linux] How to install docker in a disk other than the root disk(Azure VM)",
    description:
      "When we install docker in the Linux, the default disk is the root disk. If we want to install docker in another disk, we can use the following steps.",
  ...
  },
  {
    ...
    category:
      "[Angular] How to set the customize breakpoint when using bootstrap in Angular",
    description:
      "When we use bootstrap in Angular, we can use the customize breakpoint to set the responsive design.",
    author: "Kai　2024.3.3",
    tags: "Angular",
  },
  {
    ...
    description:
      "I use docker-desktop in the beginning, another day, I need to install Rancher-desktop for one day. After that, I remove the Rancher-desktop, and I found that the wsl has some problem.",
    author: "Kai　2024.3.3",
    tags: "Docker",
  },
  {
    ...
    description:
      "Introduction to Redis Lua script, and how to use it in Spring Boot.",
  ...
  },
  {
    ...
    description:
      "This project is a skeleton of Spring Boot + Redis OM + Redis stack. The purpose of this project is to provide some demo code for the Redis OM and the Redis stack.",
  ...
  },
  {
    ...
    description:
      "Redis stack is an enhanced version of redis, add  a lot of modules to redis, such as: search, graph, time series, JSON, AI, etc.",
  ...
  },
  {
    ...
    description:
      "Redis is an open source, in-memory data structure store, no relational database management system, it can be used as a database, cache and message broker.",
  ...
  },
  {
    ...
    description:
      "Kubernetes-dashboard is a web-base UI for Kubernetes. We can use it to monitor our cluster, manage our resources, and troubleshoot our cluster.",
  ...
  },
  {
    ...
    description:
      "SonaType Nexus Repository Manager 是一個用來管理軟體套件的私有倉庫，可以用來存放各種軟體套件，例如：Java、Node.js、Python、Docker、Maven、Gradle等等。",
  ...
  },
  {
    ...
    description:
      "原生的 Kafka 並沒有提供例外處理的功能，但是我們可以透過自定義的方式來達到例外處理的效果。",
    author: "Kai　2022.2.3",
  ...
  },
  {
    ...
    description:
      "資料倉儲是一個用來存放大量資料的系統，這些資料來自於不同的資料來源，並且經過處理後，可以用來進行分析、報表、BI等等的應用。",
  ...
  },
  {
    ...
    description:
      "github copilot for cli 是一個可以在終端機上使用的工具，可以幫助我們快速或理解command line的指令。",
  ...
  },
  {
    ...
    description:
      "這是一篇以Java出發，整理各種設計模式的文章，目前還在持續更新中，有興趣的可以看看，有錯誤的地方歡迎指正，謝謝。",
    author: "Kai　2023.11.14",
  ...
  },
  {
    ...
    description:
      "Jenkins是一個開源的自動化伺服器，用於自動化各種任務，包括建置、測試和部署軟體。",
  ...
  },
  {
    ...
    description:
      "JUC是Java.util.concurrent的縮寫，是Java5之後提供的並發處理API，包含了許多實用的工具類，可以讓我們更方便的進行並發程式的開發。",
  ...
  },
  {
    ...
    description:
      "Conventional Commits 是一種規範化的提交訊息格式，它可以讓你的提交訊息更加清晰、更容易被機器解析，並且可以生成 CHANGELOG。",
    author: "Kai　2023.11.1",
    tags: "Git",
  },
  {
  ...
  },
  {
    ...
    description:
      "不負責任的整理了一下 Java 8 - 17 的 jeps，有興趣的可以看看，有錯誤的地方歡迎指正，謝謝。",
  ...
  },
  {
    ...
    description:
      "Cypress是一個開源的端對端測試框架，它可以幫助開發人員在網頁應用程序上進行自動化測試。Cypress與其他測試框架不同之處在於它直接在瀏覽器中運行。",
  ...
  },
  {
    ...
    description:
      "kafka是一個分散式的基於發布訂閱模式的消息列隊，主要應用於大數據處裡，也特別適合微服務架構下的應用場景，用於取代傳統的消息中間件。",
  ...
  },
  {
    ...
    description:
      "利用docker desktop for windows 來建立一個k8s的環境，並且利用spring boot來建立一個簡單的web server，並且將其部署到k8s上。",
...
const renderBlogPage = (page, category, searchTerm) => {
            ...
            <div class="card-body">
              <div class="card-category-article-box">
                <div class="card-category">
                  <h6 class="category" style="overflow-wrap: break-word;">${
                    blog.category
                  }</h6>
                </div>
              </div>
              <div class="card-description-wrapper" 
                ...
                <p class="card-description mt-3 text-wrap">${
                  blog.description
                }</p>
              </div>
            </div>
  ...
  document.getElementById("pagination").innerHTML = `
    <div class="pagination-controls text-center">
      ${
        currentPage > 1
          ? `<button class="btn btn-secondary mx-2" style="background-color: #6c757d; color: white;" onclick="changePage(${
              currentPage - 1
            })">上一頁</button>`
          : ""
      }
      <span style="font-weight: bold;">頁數: ${currentPage} / ${Math.ceil(
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const updateArrows = () => {
    ...
    if (
      categoryContainer.scrollLeft + categoryContainer.clientWidth <
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.addEventListener("touchstart", function (e) {
    if (
      ...
      !hoverContainer.contains(e.target)
    ) {
      activeElement.classList.remove("active");
      hideImage();
      activeElement = null;
